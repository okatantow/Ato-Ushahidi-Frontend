                                    ...
                                    <div>
                                        ...
                                        <div className="grid gap-6 mb-6 md:grid-cols-2 pt-4">
                                            <div>
                                                ...
                                                <input type="text" id="latitude" name="latitude" onChange={handleChange} disabled value={formValue.latitude} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:bg-white block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required />
                                            </div>
                                            <div>
                                        ...
                                        <div className="mb-6">
                                            <label htmlFor="entity_type" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Entity Type</label>

                                            <select  style={{ width: "100%" }} className="border border-gray-200 rounded-lg min-h-[2.5em] " value={formValue.entity_type} required onChange={handleChange}  name="entity_type">
