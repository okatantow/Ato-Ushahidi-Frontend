        ...
        <Card.Body className="table-full-width table-responsive px-0" style={{ padding: 0 }}>
          <Row>
            <Col md="2" className="md:min-h[400px]">
              <Card.Header>
                ...
                {(collectionOn && collectionIdNew !== 0) && (
                  ...
                  <p className="flex items-start justify-between text-[0.65em]">
                    ...
                    <span className="cursor-pointer underline text-red-600" onClick={() => dispatch(removeCollections({ name: '', collectionId: '' }))}>Clear</span>
                  </p>
                )}
              </Card.Header>
              ...
              <div className="text-sm pl-2 font-medium text-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700">
                <ul className="flex flex-wrap -mb-px ">
                  ...
                  <li className="me-2">
                    <a href="#" className="inline-block p-4 border-b-2 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500" aria-current="page">Surveys({selectedSurveys.length})</a>
                  </li>
                  {/* <li className="me-2">
              ...
              <div className="p-2 py-4">
                ...
                {uniqueSurveys.map((survey) => (
                  ...
                  <div key={survey} className="flex items-start mb-2 p-2 pt-3 bg-gray-100 cursor-pointer">
                    <div className="flex items-center h-5">
                      <input type="checkbox"
                        checked={selectedSurveys.includes(survey)}
                        onChange={() => handleSurveyChange(survey)} className="w-5 h-5 border border-gray-300 rounded-sm bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800" required />
                    </div>
                    <label className="ms-2 text-sm font-medium text-black">{survey}
                    </label>
                  </div>
                ))}
            ...
            <Col md="10" className="p-2 bg-[#f5f5f5]">
              <FilterTopNav
                selectedCategories={selectedCategories} uniqueCategories={uniqueCategories} handleCategoryChange={handleCategoryChange}
                selectedStatuses={selectedStatuses} uniqueStatuses={uniqueStatuses} handleStatusChange={handleStatusChange}
                clearFilters={clearFilters}
                handleLocationSelect={handleLocationSelect} setLocationFilter={setLocationFilter} locationFilter={locationFilter} handleRangeSelect={handleRangeSelect}
                dateRange={dateRange} handleDateRangeChange={handleDateRangeChange}
              ...
              />
              {pending && (<div className="flex items-center justify-center mb-2 mt-4">
              ...
              {/* <PostSearch posts={postData} pending={pending} /> */}
