...
function SinglePostListCard(props) {
    return (
        <>
            ...
            <div className="min-h-[50px] rounded shadow-sm pl-2 grid grid-cols-1 gap-1 items-start justify-start py-2" style={{ border:'1px solid #f5f5f5', borderLeft: '10px solid black' }}>
