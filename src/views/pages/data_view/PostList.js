...
const handleAssignPost = () =>{
  ...
  return (
    <div className="md:min-h-[calc(100vh-300px)]">
        ...
        <div className="md:flex items-center justify-center md:min-h-[calc(100vh-400px)]">
            <div className="bg-white p-5 font-semibold text-[1.5em]">No Results Found For This Deployment</div>
            </div>
