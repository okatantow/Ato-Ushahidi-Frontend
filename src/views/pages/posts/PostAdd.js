...
function PostAdd(props) {
    ...
    const addRecordInstance = async (data) => {
        ...
        setPending(true);
        const results = await axiosInstance.post('addPostCustom',
            JSON.stringify(data),
            {
                headers: {
                        ...
                        <Card.Header>
                            <Card.Title as="h4">
                                ...
                                <div className="flex items-start justify-between">
                                    <span>Post | <span className="text-[0.6em] capitalize"> {props?.formType} </span> <span className="text-[0.6em] capitalize font-bold">{props?.record.survey_name}</span></span>
                            ...
                            >
                                ...
                                <div className="md:min-h-[450px] relative md:px-10">
                                    ...
                                    <div>
                                        ...
                                        <div className="mb-6">
                                            <label htmlFor="description" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Describe the post</label>
